...
export default class ItemInTransit extends Component {
            ...
            <Layout>
                ...
                <div className="flex flex-row bg-white rounded-md shadow-md my-5 p-4 gap-x-3">
                    ...
                    <div className="flex-1 flex flex-col">
                        ...
                        <p className="text-tangerine uppercase font-bold text-sm">Approx. 14 days to go</p>
                    ...
                    <div className="flex-1 flex flex-col">
                        ...
                        <h1 className="text-bold text-gray-900 uppercase font-extrabold  mb-5">Track racking</h1>
                        ...
                        <div className="flex flex-col md:flex-row gap-x-4 bg-transparent">
                            ...
                            <div className="flex md:contents">
                                ...
                                <div className="bg-transparent col-start-4 col-end-12 p-1 rounded-xl my-1 mr-auto w-full">
                                    ...
                                    <h3 className="text-sm font-extrabold mb-1 text-gray-300 uppercase">Items arrived in Nairobi</h3>

                                    <p className="leading-tight text-justify w-full text-gray-300 text-xs font-extrabold">23/05/2021</p>

                                    <p className="leading-tight text-justify w-full text-gray-300 text-xs font-extrabold capitalize">12:45 hrs</p>
                        ...
                        <div className="flex flex-col md:flex-row gap-x-4 bg-transparent">
                            ...
                            <div className="flex md:contents">
                                ...
                                <div className="bg-transparent col-start-4 col-end-12 p-1 rounded-xl my-1 mr-auto w-full">
                                    ...
                                    <h3 className="text-sm font-extrabold mb-1 text-gray-900 uppercase">Left holding facility in china</h3>

                                    <p className="leading-tight text-justify w-full text-litudian-orange text-xs font-extrabold">23/05/2021</p>

                                    <p className="leading-tight text-justify w-full text-litudian-orange text-xs font-extrabold capitalize">12:45 hrs</p>
                        ...
                        <div className="flex flex-col md:flex-row gap-x-4 bg-transparent">
                            ...
                            <div className="flex md:contents">
                                ...
                                <div className="bg-transparent col-start-4 col-end-12 p-1 rounded-xl my-1 mr-auto w-full">
                                    ...
                                    <h3 className="text-sm font-extrabold mb-1 text-gray-300 uppercase">Items inspected and cleared</h3>
                        ...
                        <div className="flex flex-col md:flex-row gap-x-4 bg-transparent">
                            ...
                            <div className="flex md:contents">
                                ...
                                <div className="bg-transparent col-start-4 col-end-12 p-1 rounded-xl my-1 mr-auto w-full">
                                    ...
                                    <h3 className="text-sm font-extrabold mb-1 text-gray-300 uppercase">Transported from warehouse</h3>
                        ...
                        <div className="flex flex-col md:flex-row gap-x-4 bg-transparent">
                            ...
                            <div className="flex md:contents">
                                ...
                                <div className="bg-transparent col-start-4 col-end-12 p-1 rounded-xl my-1 mr-auto w-full">
                                    ...
                                    <h3 className="text-sm font-extrabold mb-1 text-gray-300 uppercase">Item Ordered</h3>
